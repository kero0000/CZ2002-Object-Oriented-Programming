...
public class OrderUI {
    ...
    public void createOrder() {
        ...
        try {
			...
			if(r == null) {
				System.out.println("Table is not taken by anyone.");
				return;
			}
        ...
        if(order.getItems().size() == 0) {
        	...
        	System.out.println("Order created for room " + tableId);
        }
    ...
    public void viewOrder() {
    	...
    	if (OrderController.getInstance().displayOrder() > 0) {
        	...
        	do {
    		    try {
    		    	System.out.println("View order by (0 - Order ID, 1 - Table ID):");
    	        	choice = sc.nextInt();
